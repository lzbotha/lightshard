...
public class SpawnerController : MonoBehaviour {
	...
	void Start () {
		...
		if (PlayerPrefs.GetInt("isCoop") == 0) {
			...
			PlayerState player = (PlayerState) Instantiate (playerPrefab, this.playerOnePosition, Quaternion.identity);
			player.player = 1;
			...
			// Coop.
			Debug.Log ("Coop");
			PlayerState player1 = (PlayerState) Instantiate (playerPrefab, this.playerOnePosition, Quaternion.identity);
			player1.player = 1;
			player1.playersInLevel =  2;

			PlayerState player2 = (PlayerState) Instantiate (playerPrefab, this.playerTwoPosition, Quaternion.identity);
			player2.player = 2;
